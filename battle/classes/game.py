...
class Person:
    ...
    def get_enemy_stats(self):
        ...
        whitespaces = (7 - len(self.name)) * " "
        print("                      __________________________________________________")
        print(bcolors.BOLD + self.name, whitespaces +
    ...
    def get_stats(self):
        ...
        whitespaces = (10 - len(self.name)) * " "
        print("                      _________________________             __________")
        print(bcolors.BOLD + self.name + whitespaces +
              current_hp + "  |" + bcolors.OKGREEN + hp_bar + bcolors.ENDC + bcolors.BOLD + "|  " +
              current_mp + "  |" + bcolors.OKBLUE + mp_bar + bcolors.ENDC + bcolors.BOLD + "|")
